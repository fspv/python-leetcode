...
class StatStatusPair(object):
    ...
    def __init__(self, stat=None, status=None, difficulty=None, paid_only=None, is_favor=None, frequency=None, progress=None):  # noqa: E501
    ...
    def paid_only(self, paid_only):
        ...
        if paid_only is None:
            raise ValueError("Invalid value for `paid_only`, must not be `None`")  # noqa: E501
    ...
    def is_favor(self, is_favor):
        ...
        """
        if is_favor is None:
            raise ValueError("Invalid value for `is_favor`, must not be `None`")  # noqa: E501
