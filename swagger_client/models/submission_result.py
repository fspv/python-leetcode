...
import six
from swagger_client.models.base_submission_result import BaseSubmissionResult  # noqa: F401,E501
...
class SubmissionResult(BaseSubmissionResult):
    ...
    def __init__(self, compare_result=None, std_output=None, last_testcase=None, expected_output=None, input_formatted=None, input=None, *args, **kwargs):  # noqa: E501
    ...
    def compare_result(self, compare_result):
        ...
        if compare_result is None:
            raise ValueError("Invalid value for `compare_result`, must not be `None`")  # noqa: E501
    ...
    def std_output(self, std_output):
        ...
        if std_output is None:
            raise ValueError("Invalid value for `std_output`, must not be `None`")  # noqa: E501
    ...
    def last_testcase(self, last_testcase):
        ...
        if last_testcase is None:
            raise ValueError("Invalid value for `last_testcase`, must not be `None`")  # noqa: E501
    ...
    def input_formatted(self, input_formatted):
        ...
        if input_formatted is None:
            raise ValueError("Invalid value for `input_formatted`, must not be `None`")  # noqa: E501
